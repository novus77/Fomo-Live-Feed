...
export const EN_MESSAGES = {
  ...
  'pumpStatus.live': 'Live',
  'pumpStatus.catchingUp': 'Catching up',
  'pumpStatus.delayed': 'Delayed',
  'pumpStatus.rateLimited': 'Rate limited',
  ...
  'feed.noMatches':
    'No activity matches the current filters. Adjust or reset filters to see more.',
  ...
  'feed.quickFiltersAria': 'Quick feed filters',
  'feed.quickActionFilters': 'Quick action filters',
  'feed.quickSourceFilters': 'Quick source filters',
  ...
  'feed.filterSummary': 'Filters · {count} active: {details}',
  'feed.filterSummarySource': 'Source {source}',
  'feed.filterSummaryActions': 'Hidden {actions}',
  'feed.filterSummaryChains': 'Chains {chains}/{total}',
  'feed.filterSummaryBuyAmount': 'Buy {range}',
  'feed.filterSummaryMarketCap': 'MC {range}',
  ...
  'feed.filterBuyAmount': 'Buy amount',
  'feed.filterBuyAmountMinimum': 'Minimum buy amount in USD',
  'feed.filterBuyAmountMaximum': 'Maximum buy amount in USD',
  'feed.filterBuyAmountInvalid': 'Enter non-negative buy amounts.',
  'feed.filterBuyAmountReversed': 'Minimum buy amount cannot exceed maximum.',
...
export const ZH_MESSAGES: Record<MessageKey, string> = {
  ...
  'pumpStatus.live': '实时',
  'pumpStatus.catchingUp': '正在补齐',
  'pumpStatus.delayed': '延迟',
  'pumpStatus.rateLimited': '已限流',
  ...
  'feed.scanExceeded':
    '当前筛选条件匹配的记录很少，因此只检查了部分历史。请放宽或重置一个或多个筛选条件，再查找更早的记录。',
  ...
  'feed.quickFiltersAria': '快速动态筛选',
  'feed.quickActionFilters': '快速状态筛选',
  'feed.quickSourceFilters': '快速来源筛选',
  ...
  'feed.filterSources': '来源',
  'feed.allSources': '全部来源',
  'feed.filterActions': '显示动态类型',
  'feed.filterChains': '链',
  'feed.selectedChains': '已选 {selected}/{total}',
  'feed.filterSummary': '筛选 · {count} 项生效：{details}',
  'feed.filterSummarySource': '来源 {source}',
  'feed.filterSummaryActions': '隐藏 {actions}',
  'feed.filterSummaryChains': '链 {chains}/{total}',
  'feed.filterSummaryBuyAmount': '买入 {range}',
  'feed.filterSummaryMarketCap': 'MC {range}',
  'feed.selectAll': '全选',
  ...
  'feed.filterBuyAmount': '买入金额',
  'feed.filterBuyAmountMinimum': '最低买入金额（美元）',
  'feed.filterBuyAmountMaximum': '最高买入金额（美元）',
  'feed.filterBuyAmountInvalid': '请输入非负买入金额。',
  'feed.filterBuyAmountReversed': '最低买入金额不能高于最高买入金额。',
