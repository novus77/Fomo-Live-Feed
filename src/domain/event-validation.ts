 ...
 * both consumers:
 *
 * - src/overlay/trading-overlay.ts re-validates the worker's
 *   activity.broadcast payload field by field before a card is pushed
 *   (defense in depth: only known fields survive);
